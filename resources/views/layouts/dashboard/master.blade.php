...
<head><base href="">
    ...
    <link href="{{ asset('dashboard_assets/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css') }}" rel="stylesheet" type="text/css" />
    <!--end::Page Vendors Styles-->

    <!--begin::Global Theme Styles(used by all pages)-->
    <link href="{{ asset('dashboard_assets/css_ar/style.bundle.rtl.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('dashboard_assets/css_ar/plugins.bundle.rtl.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('dashboard_assets/css_ar/prismjs.bundle.rtl.css') }}" rel="stylesheet" type="text/css" />
...
<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
    <!--begin::Logo-->
    <a href="">
        <img alt="Logo" src="{{ asset('dashboard_assets/assets/media/logos/logo-light.png') }}" />
    </a>
    <!--end::Logo-->
    <!--begin::Toolbar-->
        ...
        <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
            ...
            <div class="brand flex-column-auto" id="kt_brand">
                ...
                <a href="" class="brand-logo">
                    <img alt="Logo" src="{{ asset('dashboard_assets/assets/media/logos/logo11.png') }}" />
                </a>
                <!--end::Logo-->
                <!--begin::Toggle-->
...
<script src="{{asset('dashboard_assets/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js')}}"></script>
<!--end::Page Vendors-->
<!--begin::Page Scripts(used by this page)-->
<script src="{{ asset('dashboard_assets/assets/js/pages/widgets.js') }}"></script>
<!--end::Page Scripts-->
{{-- datatables --}}
