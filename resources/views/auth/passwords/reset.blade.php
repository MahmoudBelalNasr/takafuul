        ...
        <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url(dashboard_assets/assets/media/bg/bg-2.jpg);">
            <div class="login-form text-center text-white p-7 position-relative overflow-hidden">
                ...
                <div class="login-signin">
                    <div class="mb-20">
                        <h3 class="opacity-40 font-weight-normal">تأكيد كلمة المرور الجديدة</h3>
                    </div>
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="form-group">
                            <input id="email" type="email" class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8 @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}"
                                   required autocomplete="email" autofocus placeholder="البريد الالكترونى">
                        ...
                        <div class="form-group">
                            <input id="password" type="password" class="form-control form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8 @error('password') is-invalid @enderror" name="password"
                        ...
                        <div class="form-group">
                            <input id="password-confirm" type="password" class="form-control form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8"
                                   name="password_confirmation" required autocomplete="new-password" placeholder="تأكيد كلمة المرور">
                        </div>


                        <div class="form-group text-center mt-10">
                            <button type="submit" class="btn btn-pill btn-primary opacity-90 px-15 py-3">تغيير كلمة المرور</button>
                        </div>
