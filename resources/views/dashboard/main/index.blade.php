...
@section('title')
    تكافل للرعاية الصحية | لوحة التحكم
@endsection
                            ...
                            <div class="card-header border-0 bg-danger py-5">
                                ...
                                <div class="card-toolbar">
                                    <div class="dropdown dropdown-inline">
                                        <span class="label label-warning label-wide">0</span>
                                    </div>
                                </div>
                            </div>
                            <!--end::Header-->
                        ...
                        <div class="card card-custom card-stretch gutter-b">
                            ...
                            <div class="card-header align-items-center border-0 mt-4">
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="font-weight-bolder text-dark">الاتصال بنا</span>
                                </h3>
                                <div class="card-toolbar">
                                    <div class="dropdown dropdown-inline">
                                        <span class="label label-danger label-wide">0</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12 col-xxl-4 order-1 order-xxl-2">
                        ...
                        <div class="card card-custom card-stretch gutter-b">
                            ...
                            <div class="card-header border-0 text-right ">
                                <h3 class="card-title font-weight-bolder text-dark">سجل النشاطات</h3>
                                <div class="card-toolbar">
                                    <div class="dropdown dropdown-inline">
                                        <span class="label label-danger label-wide">0</span>
                                    </div>
