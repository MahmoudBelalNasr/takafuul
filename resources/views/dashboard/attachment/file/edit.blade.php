...
@section('title')
    تكافل للرعاية الصحية | تعديل الملفات
@endsection
...
@section('content')
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-4">
            <h4 class="font-weight-bolder"><span class="badge badge-pill badge-danger">تعديل ملف</span> </h4>
        </div>
                            ...
                            <div class="card">
                                <div class="card-body" id="print">
                                    <form action="{{ route('attachment.update', $attachment->id) }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <iframe src="{{ asset('/uploads/files_library/'.$attachment->attachment) }}" width="400px" height="300px"></iframe><br><br>
