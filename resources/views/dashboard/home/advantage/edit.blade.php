                ...
                <div class="card wow margin">
                    <div class="row margin">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('advantage.update', $advantage->id) }}" method="post">
                                        @csrf
                                        @method("PATCH")
                                        <div class="form-group">
                                            <label for="name">العنوان:</label>
                                            <input type="text" class="form-control" name="text" value="{{ $advantage->text }}" placeholder="ادخل النص">
                                            @error('text')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="icon" value="{{ $advantage->icon }}" placeholder="ادخل الايقونة">
                                            @error('icon')
                                            <small class="form-text text-danger">{{$message}}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <button type="submit" class="btn btn-primary">تعديل مميزاتنا</button>
