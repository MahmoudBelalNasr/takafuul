...
@section('title')
    تكافل للرعاية الصحية | الطلبات الجديدة
@endsection
    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-4">
            <h4 class="font-weight-bolder">
                <span class="badge badge-pill badge-danger">الطلبات الجديدة</span>
            </h4>
        </div>
                                    ...
                                    <table class="table table-bordered text-center myTable" style="border: 1px solid black;" >
                                        ...
                                        @foreach($orders as $order)
                                            ...
                                            <tr>
                                                ...
                                                <th>{{ $order->city_id }}</th>
                                                <th>{{ $order->title }}</th>
                                                <th><span class="badge badge-pill badge-warning">جديد</span></th>
                                                ...
                                                <th id="print_hidden">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                            <a href="{{ route('order.status.sent', $order->id) }}" class="dropdown-item" type="button"> <i class="fas fa-share-square"></i> تم الارسال </a>
                                                            <a href="{{ route('order.status.delivered', $order->id) }}" class="dropdown-item" type="button"> <i class="fas fa-handshake"></i> تم التسليم </a>
                                                            <a href="{{ route('order.status.delayed', $order->id) }}" class="dropdown-item" type="button"> <i class="fas fa-clock"></i> تأجلت </a>
                                                            <a href="{{ route('order.status.noreply', $order->id) }}" class="dropdown-item" type="button"> <i class="fas fa-exclamation-circle"></i> عدم الرد </a>
                                                            <a href="{{ route('order.status.canceled', $order->id) }}" class="dropdown-item" type="button"> <i class="fas fa-window-close"></i> ملغية </a>
