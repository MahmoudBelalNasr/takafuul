...
@section('title')
    تكافل للرعاية الصحية | الطلبات تم الارسال
@endsection
    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-4">
            <h4 class="font-weight-bolder">
                <span class="badge badge-pill badge-danger">الطلبات تم الارسال</span>
            </h4>
        </div>
                                    ...
                                    <table class="table table-bordered text-center myTable" style="border: 1px solid black;" >
                                        ...
                                        @foreach($orders as $order)
                                            ...
                                            <tr>
                                                ...
                                                <th>{{ $order->city_id }}</th>
                                                <th>{{ $order->title }}</th>
                                                <th><span class="badge badge-pill badge-warning">تم الارسال</span></th>
