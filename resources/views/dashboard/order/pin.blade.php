    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-4">
            <h4 class="font-weight-bolder">
                <span class="badge badge-pill badge-danger"> المهملات</span>
            </h4>
        </div>
                                                ...
                                                <th id="print_hidden">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                            <a href="{{ route('order.delete.restore', $order->id) }}" class="dropdown-item" type="button"> <i class="fas fa-edit"></i> استرجاع الطلب</a>
                                                            <a href="{{ route('order.delete.force', $order->id) }}" class="dropdown-item" type="button"> <i class="fas fa-trash"></i> حذف نهائى</a>
                                                        </div>
                                                    </div>
                                                </th>
                                            </tr>
